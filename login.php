...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html,body{min-height:100%}body{margin:0;min-height:100vh;min-height:100dvh;background:#eef3f9;font-family:Inter,"Segoe UI",sans-serif;color:var(--ink)}
        ...
        .login-card{position:relative;width:100%;max-width:430px}.brand-row{position:relative;display:flex;align-items:center;gap:14px;min-height:96px;margin-bottom:40px;padding:14px 18px;overflow:hidden;border:1px solid #e7edf5;border-radius:20px;background-image:linear-gradient(90deg,rgba(255,255,255,.99) 0%,rgba(255,255,255,.94) 48%,rgba(255,255,255,.34) 100%),url("assets/img/batikjb.webp");background-position:center;background-size:cover;background-repeat:no-repeat;box-shadow:0 12px 32px rgba(17,50,93,.08)}.brand-row::after{content:"";position:absolute;inset:auto 0 0;height:3px;background:linear-gradient(90deg,#1769e0,#37b8f1,transparent)}.logo-wrap{position:relative;z-index:1;width:66px;height:66px;display:grid;place-items:center;border:1px solid #e7edf5;border-radius:19px;background:rgba(255,255,255,.94);box-shadow:0 10px 30px rgba(17,50,93,.1)}.logo-img{width:53px;height:53px;object-fit:contain}.brand-row>div{position:relative;z-index:1}.brand-name{font-size:.92rem;font-weight:800;line-height:1.25;letter-spacing:.02em}.brand-subtitle{margin-top:3px;color:var(--muted);font-size:.75rem}
        ...
        @media(max-width:575.98px){.login-shell{padding:0;background:#fff}.login-panel{min-height:100vh;min-height:100dvh;padding:20px;border-radius:0;align-items:flex-start}.login-card{padding-top:8px}.brand-row{min-height:86px;margin-bottom:28px;padding:12px 14px;border-radius:17px;background-position:center right}.logo-wrap{width:58px;height:58px;border-radius:17px;flex:0 0 58px}.logo-img{width:47px;height:47px}.brand-name{font-size:.86rem}.brand-subtitle{font-size:.7rem}.login-title{font-size:1.75rem}.login-lead{margin-bottom:27px}.login-input,.btn-login{height:52px}.login-input{font-size:16px}.login-footer{margin-top:32px;flex-direction:column;text-align:center;gap:5px}}
