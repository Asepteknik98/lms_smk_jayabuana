...
function tugasBaru(pengajaranId=0,pertemuan=0){document.getElementById('formTugas').reset();document.getElementById('aksiTugas').value='create';document.getElementById('idTugas').value='';document.getElementById('judulModal').textContent='Buat Tugas Baru';document.getElementById('infoEdit').classList.add('d-none');pilihanGabunganTugas.classList.toggle('d-none',!adaKelasGabunganTugas);pilihanTunggalTugas.classList.toggle('d-none',adaKelasGabunganTugas);pengajaranTugas.disabled=adaKelasGabunganTugas;pengajaranTugas.required=!adaKelasGabunganTugas;jenisTugas.disabled=false;aturJenis();if(pengajaranId){if(adaKelasGabunganTugas){const pilihan=document.querySelector('.kelas-tugas[value="'+String(pengajaranId)+'"]');if(pilihan)pilihan.checked=true}else{pengajaranTugas.value=String(pengajaranId)}}if(pertemuan)document.getElementById('pertemuanTugas').value=String(pertemuan)}
...
document.getElementById('formTugas').addEventListener('submit',function(event){if(document.getElementById('aksiTugas').value==='create'&&adaKelasGabunganTugas&&!document.querySelector('.kelas-tugas:checked')){event.preventDefault();Swal.fire({icon:'warning',title:'Pilih Kelas',text:'Pilih minimal satu kelas yang menerima tugas.'})}});
