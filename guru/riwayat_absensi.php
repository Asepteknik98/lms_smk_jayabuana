...
<div id="page-content-wrapper" class="history-page">
    <nav class="navbar top-navbar px-3 px-md-4 py-3"><div class="d-flex justify-content-between align-items-center gap-2 w-100"><div><h5 class="fw-bold mb-0"><i class="fa-solid fa-clock-rotate-left text-primary me-2"></i>Riwayat Absensi</h5><small class="text-muted">Pantau seluruh sesi yang pernah dibuat</small></div><a href="absensi.php" class="btn btn-sm btn-primary flex-shrink-0"><i class="fa-solid fa-plus me-1"></i><span class="d-none d-sm-inline">Buka Absensi</span></a></div></nav>
