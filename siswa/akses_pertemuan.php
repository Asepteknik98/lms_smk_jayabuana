...
<?php for ($nomor=1;$nomor<=20;$nomor++): $item=$pelajaran['pertemuan'][$nomor]??null;$terbuka=($item['status']??'Dikunci')==='Dibuka';$tugas_terkunci=$terbuka&&!empty($item['ada_materi'])&&empty($item['sudah_review']); ?>
