...
<style>.material-accordion>.accordion-item{border:0;border-radius:17px!important;box-shadow:0 6px 20px rgba(15,23,42,.06);overflow:hidden}.material-accordion>.accordion-item>.accordion-header .accordion-button{padding:18px 20px;background:#fff}.material-accordion>.accordion-item>.accordion-header .accordion-button:not(.collapsed){color:#175fc0;background:#f5f9ff;box-shadow:none}.subject-icon{width:43px;height:43px;display:grid;place-items:center;border-radius:13px;background:#eaf3ff;color:#1769e0;flex:0 0 43px}.meeting-accordion{display:grid;gap:10px}.meeting-item{border:1px solid #e2e8f0!important;border-radius:13px!important;overflow:hidden;background:#fff}.meeting-button{padding:13px 15px!important;background:#f8fafc!important;color:#334155!important;box-shadow:none!important}.meeting-button:not(.collapsed){background:#eef6ff!important;color:#175fc0!important}.meeting-number{width:34px;height:34px;display:grid;place-items:center;border-radius:10px;background:#dbeafe;color:#1769e0;flex:0 0 34px}.meeting-task-notice{display:block;margin-top:4px;color:#9a6700!important;font-size:.7rem;line-height:1.35}.meeting-task-ready{display:block;margin-top:4px;color:#157347!important;font-size:.7rem;line-height:1.35}.meeting-item.is-complete{border-color:#a7e3bd!important}.meeting-item.is-complete .meeting-button,.meeting-item.is-complete .meeting-button:not(.collapsed){background:#ecfdf3!important;color:#157347!important}.meeting-item.is-complete .meeting-number{background:#d1fae5;color:#16803c}.meeting-item.is-complete .meeting-button small{color:#43815a!important}.meeting-body{padding:0 15px 4px!important}.material-row{padding:16px 0;border-bottom:1px solid #edf1f5}.material-row:last-child{border-bottom:0}.material-row.is-locked{opacity:.84}.material-lock-notice{border:1px dashed #cbd5e1;border-radius:12px;background:#f8fafc;color:#64748b}.material-title{overflow-wrap:anywhere}.material-description{max-height:100px;overflow:auto}.material-video{max-width:760px;border-radius:14px;overflow:hidden;background:#000}.material-video iframe{display:block;width:100%;aspect-ratio:16/9;border:0}@media(max-width:575.98px){.material-accordion>.accordion-item>.accordion-header .accordion-button{padding:14px}.material-accordion>.accordion-item>.accordion-collapse>.accordion-body{padding:10px}.meeting-button{padding:11px!important}.meeting-task-notice,.meeting-task-ready{font-size:.63rem}.meeting-body{padding:0 12px 3px!important}.material-row .btn{min-height:44px}.subject-icon{width:39px;height:39px;flex-basis:39px}.subject-copy{min-width:0}.subject-copy strong,.subject-copy small{overflow-wrap:anywhere}}</style>
